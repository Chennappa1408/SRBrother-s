...
- Name: TC05_ResetEmpDetails.spec.ts >> TC05_ResetEmpDetails
- Location: tests\TC05_ResetEmpDetails.spec.ts:5:5
...
Call log:
  - waiting for locator('//iframe[@id=\'rightMenu\']').contentFrame().locator('//input[@id=\'allCheck\']')
  ...
  - iframe [active] [ref=e311]:
    - generic [ref=f1e8]:
      ...
      - generic [ref=f1e11]:
        ...
        - textbox "Search For:" [ref=f1e15]: "5244"
      ...
      - generic [ref=f1e18]:
        ...
        - generic [ref=f1e22]: No Records to Display
      - table [ref=f1e24]:
        - rowgroup [ref=f1e25]:
          - row "Employee Id Employee Name Job Title Employment status Sub-Division Supervisor" [ref=f1e26]:
            - cell [ref=f1e27]
...
```ts
  ...
  56  |         await iframe.locator(this.search_empid_textbox).fill(this.empid);
  ...
  96  |         await iframe.locator(this.search_empid_textbox).fill(this.empid);
