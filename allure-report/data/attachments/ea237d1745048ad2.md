...
- Name: Listpage_Testsuite.spec.ts >> List of Test Suite for 69Batch >> TC05_ResetEmpDetails_regress
- Location: tests\Listpage_Testsuite.spec.ts:19:5
  ...
  - iframe [active] [ref=e311]:
    - generic [ref=f1e8]:
      ...
      - generic [ref=f1e11]:
        ...
        - textbox "Search For:" [ref=f1e15]: "5263"
